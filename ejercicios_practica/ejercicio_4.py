...
vnumerica_1= int(texto_1)
vnumerica_2= int(texto_2)


if vnumerica_1 > vnumerica_2:
    print("{} es mayor que {}".format(vnumerica_1, vnumerica_2))
else:
    print("{} es mayor que {}".format(vnumerica_2, vnumerica_1))
