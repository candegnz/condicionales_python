...
if texto_1[0:1] > texto_2[0:1]:
    print("Primera letra de {} es mayor a la de {}".format(texto_1, texto_2))
else:
    print("Primera letra de {} es mayor a la de {}".format(texto_2, texto_1))
...
if copia_texto_1 != texto_2:
    print("{} es distinto que {}".format(copia_texto_1, texto_2))
